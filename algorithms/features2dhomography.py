...
parser.add_argument('--input1', help='Path to input image 1.', default='../training_data/images/img1.JPG')
parser.add_argument('--input2', help='Path to input image 2.', default='../training_data/images/mimg.jpg')
...
# Note that since the homography is estimated with a RANSAC approach, detected false matches will not impact the homography calculation.
